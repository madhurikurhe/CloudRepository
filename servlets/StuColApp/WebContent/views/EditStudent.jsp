...
<div>
<a href="/StuColApp/showstudent" align="right">Home</a>
<a onclick="clearStorage()" href="/StuColApp/logout" align="right">Logout</a>
</div>
	<form method="post" action="/StuColApp/editstudent?id=<%=roll_no%>" >
		<div>
