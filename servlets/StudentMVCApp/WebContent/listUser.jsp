...
<%@ page import="com.techlabs.model.com.techlabs.model.Student"%>
<%@ page import="com.techlabs.dao.com.techlabs.dao.StudentDao"%>
...
<%
	...
	List<Student> userList = dao.getAllUsers();
